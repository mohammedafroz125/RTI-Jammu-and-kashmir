      ...
      >
        ...
        >
          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden" style={{ overflow: 'hidden' }}>
            {/* Video Section */}
            <div ref={videoRef} className="mb-3 mt-4 bg-white rounded-lg shadow-lg overflow-hidden border-2 border-white flex-shrink-0">
            ...
            <div className="flex-1 flex flex-col min-h-0 overflow-hidden" style={{ overflow: 'hidden' }}>
              ...
              <div className="flex-1 overflow-hidden sidebar-features-scroll" style={{ overflow: 'hidden' }}>
