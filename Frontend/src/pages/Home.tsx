...
export const Home: React.FC = () => {
  ...
  const faqStructuredData = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "Which Jammu and Kashmir departments can I file RTI applications for?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can file RTI applications for all Jammu and Kashmir Government departments including General Administration, Home, Finance, Revenue, School Education, Higher Education, Health & Medical Education, Public Works (R&B), Power Development, Jal Shakti, Agriculture, Forest & Environment, Industries & Commerce, Tourism, Housing & Urban Development, Rural Development & Panchayati Raj, Social Welfare, Labour & Employment, Transport, and many more."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "For filing an RTI in Jammu and Kashmir, you primarily need to clearly describe the information you're seeking. No identity proof is mandatory for filing, but having Aadhaar or voter ID helps for communication purposes. For BPL fee exemption, you'll need your BPL card."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, we offer anonymous RTI filing services for Jammu and Kashmir departments where your identity is protected throughout the process. Our team files the application on behalf of our organization, ensuring your privacy while exercising your right to information."
        }
      }
    ]
  };
